...
// go tool cover -html=cover.our -> untuk melihat hasil coverage (html/web)
// go test ./... -v => untuk mencari keselurahan baik itu folder atau sub folder yang memiliki file _test.go